...
// ── HELPER: Convert Google Drive link to embed link ──────────
...
const COURSES = [
  {
    id: 1, title: 'Basic Graphics Design',
    subtitle: 'Start from zero — no laptop needed',
    level: 'Beginner', price: '₦5,000', lessons: 10,
    duration: '4 hrs', students: 120, rating: 4.9,
    color: '#1976D2', emoji: '🎨', tag: 'BASIC', category: 'Design',
    objectives: ['Use Canva like a pro', 'Design posters and flyers', 'Understand color theory', 'Create social media graphics'],
    modules: [
      { title: 'Introduction to Design', lessons: 3, done: false },
      { title: 'Color & Typography', lessons: 3, done: false },
      { title: 'Your First Design', lessons: 4, done: false },
    ],
    videos: [
      { title: 'Introduction to Graphics', duration: '10:00', free: true, driveUrl: 'https://drive.google.com/file/d/1bK9r6Ng5Ww78Vj7b9SQS6DHrGVHn4LZr/view?usp=drivesdk' },
      { title: 'Introduction to App', duration: '10:00', free: true, driveUrl: 'https://drive.google.com/file/d/1bHPieGuO_iFGTmRKxBxCeyJdh3srkzmE/view?usp=drivesdk' },
      { title: 'Various Sizes in Design', duration: '15:00', free: false, driveUrl: 'https://drive.google.com/file/d/1_tQQcLAMJMQKGQh71l9h1n6r8fCTpeH0/view?usp=drivesdk' },
      { title: 'More Lessons Coming Soon', duration: '--:--', free: false, driveUrl: '' },
    ],
    resources: ['Design Color Guide PDF', 'Font Collection PDF'],
    quiz: [
      { q: 'What are the 3 primary colors?', options: ['Red, Blue, Yellow', 'Red, Green, Blue', 'Black, White, Grey', 'Purple, Orange, Green'], answer: 0 },
      { q: 'Which app is best for mobile design?', options: ['WhatsApp', 'Canva', 'TikTok', 'Chrome'], answer: 1 },
      { q: 'What is typography?', options: ['Art of color', 'Art of arranging text', 'Taking photos', 'Video editing'], answer: 1 },
    ],
  },
  {
    id: 2, title: 'Intermediate Graphics Design',
    subtitle: 'Level up your design skills',
    level: 'Intermediate', price: '₦10,000', lessons: 15,
    duration: '6 hrs', students: 85, rating: 4.8,
    color: '#7B1FA2', emoji: '🖌️', tag: 'INTER', category: 'Design',
    ...
    videos: [
      { title: 'Coming Soon — Upload your videos', duration: '--:--', free: true, driveUrl: '' },
    ],
  ...
  {
    id: 3, title: 'Full Master Graphics Design',
    subtitle: 'Become a professional designer',
    level: 'Advanced', price: '₦10,000', lessons: 25,
    duration: '12 hrs', students: 60, rating: 5.0,
    color: '#C62828', emoji: '🏆', tag: 'MASTER', category: 'Design',
    ...
    videos: [{ title: 'Coming Soon — Upload your videos', duration: '--:--', free: true, driveUrl: '' }],
  ...
  {
    id: 4, title: 'Basic Video Editing',
    subtitle: 'Edit videos like a pro on your phone',
    level: 'Beginner', price: '₦5,000', lessons: 10,
    duration: '4 hrs', students: 95, rating: 4.8,
    color: '#00695C', emoji: '🎬', tag: 'BASIC', category: 'Video',
    ...
    videos: [
      { title: 'Introduction', duration: '10:00', free: true, driveUrl: 'https://drive.google.com/file/d/1jU4ITqUwmY9h1aM0QI8GkGGqhxjt8tL6/view?usp=drivesdk' },
      { title: 'Video Ads', duration: '10:00', free: true, driveUrl: 'https://drive.google.com/drive/folders/1jUIhVsP0gc5PCDt2RlhPpkv28MQYWUfs' },
      { title: 'Ads', duration: '15:00', free: false, driveUrl: 'https://drive.google.com/drive/folders/1l9YVELFIUMcXzNRlsfwsaTL9HSbuVmit' },
      { title: 'More Lessons Coming Soon', duration: '--:--', free: false, driveUrl: '' },
    ],
  ...
  { id: 5, title: 'Intermediate Video Editing', subtitle: 'Advanced video production skills', level: 'Intermediate', price: '₦10,000', lessons: 15, duration: '7 hrs', students: 55, rating: 4.9, color: '#E65100', emoji: '🎥', tag: 'INTER', category: 'Video', objectives: ['Advanced CapCut features', 'Color grading', 'Sound design', 'Content creation'], modules: [{ title: 'Advanced Editing', lessons: 5, done: false }, { title: 'Color & Audio', lessons: 5, done: false }, { title: 'Content Strategy', lessons: 5, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Color Grading Guide', 'Sound Effects List'], quiz: [{ q: 'What is color grading?', options: ['Coloring a drawing', 'Adjusting video colors', 'Deleting colors', 'Adding stickers'], answer: 1 }] },
  { id: 6, title: 'Full Video Editing Course', subtitle: 'Complete video production mastery', level: 'Advanced', price: '₦10,000', lessons: 25, duration: '12 hrs', students: 40, rating: 5.0, color: '#1A237E', emoji: '🎞️', tag: 'MASTER', category: 'Video', objectives: ['Professional video production', 'YouTube content creation', 'Monetize your videos', 'Build audience'], modules: [{ title: 'Pro Video Production', lessons: 8, done: false }, { title: 'YouTube & Social Media', lessons: 8, done: false }, { title: 'Monetization', lessons: 9, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['YouTube SEO Guide', 'Content Calendar Template'], quiz: [{ q: 'How do you monetize YouTube?', options: ['Just posting', 'Ads, sponsors, products', 'Buying views', 'Deleting videos'], answer: 1 }] },
  { id: 7, title: 'Full Image Editing', subtitle: 'Master photo editing on your phone', level: 'Intermediate', price: '₦10,000', lessons: 15, duration: '6 hrs', students: 70, rating: 4.8, color: '#880E4F', emoji: '🖼️', tag: 'FULL', category: 'Design', objectives: ['Photo retouching', 'Background removal', 'Color correction', 'Photo manipulation'], modules: [{ title: 'Photo Basics', lessons: 5, done: false }, { title: 'Retouching', lessons: 5, done: false }, { title: 'Advanced Effects', lessons: 5, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Lightroom Presets', 'Photo Editing Checklist'], quiz: [{ q: 'What is photo retouching?', options: ['Deleting photos', 'Improving photo quality', 'Taking selfies', 'Printing photos'], answer: 1 }] },
  { id: 8, title: 'Basic Web Design & Development', subtitle: 'Build websites using your phone', level: 'Beginner', price: '₦5,000', lessons: 12, duration: '5 hrs', students: 50, rating: 4.7, color: '#004D40', emoji: '🌐', tag: 'BASIC', category: 'Tech', objectives: ['HTML & CSS basics', 'Build simple websites', 'Mobile-first design', 'Publish online for free'], modules: [{ title: 'HTML Basics', lessons: 4, done: false }, { title: 'CSS Styling', lessons: 4, done: false }, { title: 'Publishing', lessons: 4, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['HTML Cheat Sheet', 'CSS Reference Guide'], quiz: [{ q: 'What does HTML stand for?', options: ['HyperText Markup Language', 'High Tech Modern Language', 'Home Tool Markup Language', 'None'], answer: 0 }] },
  { id: 9, title: 'Complete Web Design', subtitle: 'Full professional web development', level: 'Advanced', price: '₦10,000', lessons: 25, duration: '15 hrs', students: 35, rating: 5.0, color: '#01579B', emoji: '💻', tag: 'FULL', category: 'Tech', objectives: ['Full website development', 'JavaScript basics', 'Responsive design', 'Freelance web projects'], modules: [{ title: 'Advanced HTML & CSS', lessons: 8, done: false }, { title: 'JavaScript Basics', lessons: 8, done: false }, { title: 'Freelance Projects', lessons: 9, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['JavaScript Cheat Sheet', 'Web Project Templates'], quiz: [{ q: 'What is JavaScript used for?', options: ['Styling pages', 'Making pages interactive', 'Creating images', 'Hosting websites'], answer: 1 }] },
  { id: 10, title: 'Content Writing', subtitle: 'Write content that sells and engages', level: 'Beginner', price: '₦5,000', lessons: 10, duration: '4 hrs', students: 80, rating: 4.8, color: '#33691E', emoji: '✍️', tag: 'BASIC', category: 'Writing', objectives: ['Write compelling content', 'SEO writing', 'Social media copy', 'Freelance writing'], modules: [{ title: 'Writing Fundamentals', lessons: 3, done: false }, { title: 'SEO & Digital Writing', lessons: 4, done: false }, { title: 'Freelance Writing', lessons: 3, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Content Writing Templates', 'SEO Keywords Guide'], quiz: [{ q: 'What is SEO writing?', options: ['Writing poems', 'Writing for search engines', 'Writing letters', 'Writing code'], answer: 1 }] },
  { id: 11, title: 'Data Analysis', subtitle: 'Analyse data and make smart decisions', level: 'Intermediate', price: '₦10,000', lessons: 15, duration: '8 hrs', students: 45, rating: 4.9, color: '#4527A0', emoji: '📊', tag: 'INTER', category: 'Tech', objectives: ['Excel data analysis', 'Charts and graphs', 'Data interpretation', 'Business reports'], modules: [{ title: 'Data Basics', lessons: 5, done: false }, { title: 'Excel & Spreadsheets', lessons: 5, done: false }, { title: 'Reports & Insights', lessons: 5, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Excel Formulas Guide', 'Data Analysis Templates'], quiz: [{ q: 'What is data analysis?', options: ['Deleting data', 'Examining data to find insights', 'Storing data', 'Creating data'], answer: 1 }] },
  { id: 12, title: 'Certified Microsoft Office', subtitle: 'Word, Excel, PowerPoint mastery', level: 'Beginner', price: '₦5,000', lessons: 12, duration: '6 hrs', students: 110, rating: 4.8, color: '#BF360C', emoji: '📝', tag: 'CERT', category: 'Office', objectives: ['Microsoft Word mastery', 'Excel spreadsheets', 'PowerPoint presentations', 'Get certified'], modules: [{ title: 'Microsoft Word', lessons: 4, done: false }, { title: 'Microsoft Excel', lessons: 4, done: false }, { title: 'PowerPoint', lessons: 4, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Office Keyboard Shortcuts', 'Practice Files'], quiz: [{ q: 'Which Microsoft app is used for spreadsheets?', options: ['Word', 'Excel', 'PowerPoint', 'Outlook'], answer: 1 }] },
  { id: 13, title: 'Animation', subtitle: 'Create stunning animations on your phone', level: 'Intermediate', price: '₦10,000', lessons: 15, duration: '8 hrs', students: 38, rating: 4.9, color: '#006064', emoji: '🎭', tag: 'INTER', category: 'Design', objectives: ['Motion graphics basics', 'Animated logos', 'Video animations', 'Social media animations'], modules: [{ title: 'Animation Basics', lessons: 5, done: false }, { title: 'Motion Graphics', lessons: 5, done: false }, { title: 'Advanced Animation', lessons: 5, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Animation Templates', 'Motion Graphics Pack'], quiz: [{ q: 'What is animation?', options: ['Taking photos', 'Creating moving images', 'Editing videos', 'Writing text'], answer: 1 }] },
  { id: 14, title: 'AI Skills', subtitle: 'Use AI tools to work smarter and faster', level: 'Beginner', price: '₦5,000', lessons: 10, duration: '4 hrs', students: 150, rating: 5.0, color: '#1B5E20', emoji: '🤖', tag: 'HOT🔥', category: 'Tech', objectives: ['Use ChatGPT effectively', 'AI image generation', 'AI for business', 'Automate your work'], modules: [{ title: 'AI Fundamentals', lessons: 3, done: false }, { title: 'AI Tools', lessons: 4, done: false }, { title: 'AI for Business', lessons: 3, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Top 50 AI Tools Guide', 'ChatGPT Prompts Pack'], quiz: [{ q: 'What is ChatGPT?', options: ['A social media', 'An AI chatbot', 'A video game', 'A website'], answer: 1 }] },
  { id: 15, title: 'App Design & Development', subtitle: 'Design and build mobile apps', level: 'Advanced', price: '₦10,000', lessons: 20, duration: '12 hrs', students: 30, rating: 5.0, color: '#37474F', emoji: '📱', tag: 'MASTER', category: 'Tech', objectives: ['App UI/UX design', 'Build real apps', 'Publish to Play Store', 'Earn from apps'], modules: [{ title: 'App Design Basics', lessons: 6, done: false }, { title: 'App Development', lessons: 7, done: false }, { title: 'Publishing & Earning', lessons: 7, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['App Design Templates', 'Play Store Guide'], quiz: [{ q: 'What is UI design?', options: ['User Interface design', 'Underground Internet', 'Unique Identity', 'Universal Input'], answer: 0 }] },
  { id: 16, title: 'Proposal & Project Writing', subtitle: 'Write winning proposals and projects', level: 'Beginner', price: '₦5,000', lessons: 10, duration: '5 hrs', students: 65, rating: 4.8, color: '#4E342E', emoji: '📄', tag: 'BASIC', category: 'Writing', objectives: ['Business proposals', 'Seminar papers', 'Project writing', 'Academic writing'], modules: [{ title: 'Writing Fundamentals', lessons: 3, done: false }, { title: 'Proposal Writing', lessons: 4, done: false }, { title: 'Project & Seminar', lessons: 3, done: false }], videos: [{ title: 'Coming Soon', duration: '--:--', free: true, driveUrl: '' }], resources: ['Proposal Template', 'Project Writing Guide'], quiz: [{ q: 'What is a business proposal?', options: ['A love letter', 'A document to pitch ideas', 'A receipt', 'A contract'], answer: 1 }] },
];
...
function VideoPlayer({ video, onClose }) {
  const embedUrl = getDriveEmbed(video.driveUrl);
  return (
    <Modal visible={true} animationType="slide" onRequestClose={onClose}>
      <View style={{ flex: 1, backgroundColor: '#000' }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, backgroundColor: C.bg }}>
          <Text style={{ color: C.white, fontWeight: '700', fontSize: 14, flex: 1 }} numberOfLines={1}>{video.title}</Text>
          <TouchableOpacity onPress={onClose} style={{ marginLeft: 12 }}>
            <Text style={{ color: C.accent, fontSize: 16, fontWeight: '800' }}>✕ Close</Text>
          </TouchableOpacity>
        </View>
        <WebView
          source={{ uri: embedUrl }}
    ...
    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 100 }}>
      ...
      <View style={s.section}>
        ...
        <View style={s.whyGrid}>
          {[{ icon: '📱', title: 'Phone Only', desc: 'No laptop needed' }, { icon: '🏆', title: 'Certificate', desc: 'Free on completion' }, { icon: '💰', title: 'Earn Money', desc: 'Get paid clients' }, { icon: '💬', title: 'WhatsApp Support', desc: 'Direct instructor help' }, { icon: '🎥', title: 'HD Videos', desc: 'Clear video lessons' }, { icon: '⚡', title: 'Fast Learn', desc: 'Short practical lessons' }].map((f, i) => (
      ...
      <View style={[s.section, { marginTop: 8 }]}>
        <TouchableOpacity style={s.payBtn} onPress={() => Linking.openURL(PAYMENT_LINK)}><Text style={s.payBtnTxt}>💳 Pay & Enroll Now</Text></TouchableOpacity>
        <TouchableOpacity style={[s.waBtn, { marginTop: 10 }]} onPress={() => Linking.openURL(`https://wa.me/${WHATSAPP}?text=I want to enroll in a course`)}><Text style={s.waBtnTxt}>💬 Contact Us on WhatsApp</Text></TouchableOpacity>
      </View>
    </ScrollView>
  );
}
      ...
      {done ? (
        ...
        <View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 }}>
            ...
            <Text style={{ color: C.accent, fontSize: 13, fontWeight: '700' }}>{course.title.split(' ').slice(0, 3).join(' ')}</Text>
          </View>
...
function CertSection() {
  return (
    <View style={[s.card, { backgroundColor: '#FFD70018', borderColor: '#FFD70044', alignItems: 'center', padding: 28 }]}>
      ...
      <Text style={[s.meta, { marginBottom: 4 }]}>has successfully completed a course at</Text>
    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={{ padding: 16 }}>
          ...
          {tab === 'lessons' && (
            <View>
              <Text style={[s.meta, { marginBottom: 12 }]}>🔓 First 2 videos are FREE preview · 🔒 Paid videos unlock after payment</Text>
              {course.videos.map((v, i) => (
                <TouchableOpacity key={i} style={[s.card, { marginBottom: 10 }]}
                  onPress={() => {
                    if (v.free && v.driveUrl) setPlayingVideo(v);
                    else if (!v.free) Linking.openURL(PAYMENT_LINK);
                  }}>
                  <View style={{ flexDirection: 'row', gap: 12, alignItems: 'center' }}>
                    <View style={[s.lessonIcon, { backgroundColor: v.free ? C.accent + '22' : C.dim }]}>
                      <Text style={{ fontSize: 18 }}>{v.driveUrl === '' ? '⏳' : v.free ? '▶️' : '🔒'}</Text>
                    </View>
                    <View style={{ flex: 1 }}>
                    ...
                    {v.free && v.driveUrl !== '' && <View style={[s.badge, { backgroundColor: C.greenSoft }]}><Text style={{ color: C.green, fontSize: 9, fontWeight: '800' }}>FREE</Text></View>}
                    {!v.free && <View style={[s.badge, { backgroundColor: C.accent + '22' }]}><Text style={{ color: C.accent, fontSize: 9, fontWeight: '800' }}>PAID</Text></View>}
                  </View>
                  {!v.free && v.driveUrl !== '' && (
                    <View style={s.unlockBtn}>
                      <Text style={s.unlockTxt}>🔓 Tap to Pay & Unlock — {course.price}</Text>
                    </View>
                  )}
                </TouchableOpacity>
              ))}
          ...
          {tab === 'qa' && (
            <View>
              ...
              <TouchableOpacity style={[s.waBtn, { marginTop: 10 }]} onPress={() => Linking.openURL(`https://wa.me/${WHATSAPP}?text=Question about ${course.title}: `)}><Text style={s.waBtnTxt}>💬 Ask on WhatsApp (Faster Reply)</Text></TouchableOpacity>
              {qas.map((qa, i) => (
                <View key={i} style={[s.card, { marginTop: 10 }]}>
                  ...
                  <Text style={{ color: C.green, fontSize: 12 }}>📩 Your question has been sent! Check WhatsApp for reply from {INSTRUCTOR}</Text>
                </View>
              ))}
            </View>
          )}
